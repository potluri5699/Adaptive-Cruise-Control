...
namespace audibot_final_project {
  ...
  {
    gps_a1_sub =  n.subscribe("/a1/gps/fix", 1, &final_project::recvFixa1, this);
    gps_a2_sub =  n.subscribe("/a2/gps/fix", 1, &final_project::recvFixa2, this);
    vel_path_a1 =  n.subscribe("/a1/path/cmd_vel", 1, &final_project::recvPathVela1, this);
    vel_path_a2 =  n.subscribe("/a2/path/cmd_vel", 1, &final_project::recvPathVela2, this);
  ...
  void final_project::recvFixa1(const sensor_msgs::NavSatFixConstPtr& msg)
  {
  ...
  void final_project::recvFixa2(const sensor_msgs::NavSatFixConstPtr& msg)
  {
  ...
  void final_project::recvPathVela1(const geometry_msgs::TwistConstPtr& msg)
  {
    a1_path_linx = msg->linear.x;
    a1_path_angz = msg->angular.z;
  }

  void final_project::recvPathVela2(const geometry_msgs::TwistConstPtr& msg)
  {
